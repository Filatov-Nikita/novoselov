          ...
          <div class="map-flat">
            <div class="lg:tw-w-full lg:tw-flex lg:tw-justify-end">
              <div
                ...
                <button
                  class="tw-bg-gray tw-text-white tw-py-15 tw-px-28"
                  :class="[visibleImage === 2 ? ' tw-bg-secondary' : '']"
                  @click="visibleImage = 2">
                  С мебелью
                </button>
                <button
                  class="tw-bg-gray tw-text-white tw-py-15 tw-px-28"
                  :class="[visibleImage === 1 ? ' tw-bg-secondary' : '']"
                  @click="visibleImage = 1">
                  Без мебели
                </button>
                <button
                  class="tw-bg-gray tw-text-white tw-py-15 tw-px-28"
                  :class="[visibleImage === 3 ? ' tw-bg-secondary' : '']"
