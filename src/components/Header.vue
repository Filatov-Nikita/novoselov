<template>
  <header class="tw-relative tw-z-50" v-click-outside="onOutside">
    <div
      class="tw-border-dark-line tw-border-opacity-15 tw-border-b tw-py-[13px] lg:tw-py-[23px] 2xl:tw-py-[17px] tw-bg-primary tw-backdrop-blur-[14px]"
      :class="[opacityClass]">
      <div class="wrapper 2xl:tw-max-w-none 2xl:tw-px-40">
        <div class="tw-flex tw-items-center tw-justify-between">
          <div class="tw-flex tw-gap-16 tw-items-end">
            ...
            <span
              class="tw-text-base tw-leading-120 tw-text-gray tw-hidden 2xl:tw-block">
              Жилой комплекс <br />
              в Инорсе
            </span>
          </div>
          <div
            class="tw-hidden lg:tw-flex tw-items-center tw-justify-end tw-grow">
            <router-link
            ...
            <div
              class="tw-hidden lg:tw-block tw-leading-120 lg:tw-mr-[12px] 2xl:tw-mr-[38px]">
              <a
              ...
              <a
                class="tw-underline tw-text-base"
                href="#"
